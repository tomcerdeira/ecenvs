...
import { getEnvironmentForContainer } from '@renderer/lib/api';
        ...
        <div className="relative min-h-screen overflow-hidden bg-background text-foreground">
          ...
          <div className="relative z-10 flex min-h-screen flex-col md:flex-row">
            ...
            <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
              <Header
                description="Connect to an ECS cluster and service, pick a container, then view and edit plain environment variables locally. Saving to ECS is not available yet."
                title="Connection"
              />
              <MainPanel>
                    ...
                    <section className="rounded-xl border border-border/80 bg-card/40 p-6 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.04),0_24px_48px_-24px_rgba(0,0,0,0.55)] backdrop-blur-md sm:p-8">
                      <div className="flex flex-col gap-1">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Values are masked by default. Changes stay on this machine until save is
                          implemented.
                        </p>
                      </div>
